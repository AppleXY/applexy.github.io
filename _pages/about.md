...
I am a final-year Ph.D. student at [CISPA Helmholtz Center for Information Security](https://cispa.de/en), supervised by [Michael Backes](https://cispa.de/en/about/director-page). Prior to that, I obtained my bachelor (2018) and master (2021) degrees from University of Science and Technology of China (USTC).
...
* [Inside the Black Box: Detecting Data Leakage in Pre-trained Language Encoders](https://arxiv.org/abs/2401.07603)  
  **Yuan Xin**, Zhengyang Li, Ning Yu, Dongping Chen, Mario Fritz, Michael Backes, Yang Zhang. *ECAI 2024*.
